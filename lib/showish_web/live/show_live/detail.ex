    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      ...
      <div class="rounded-box border border-base-300 bg-base-200 p-5">
        ...
        <ol class="mt-2 list-decimal space-y-1 pl-5 text-sm text-base-content/70">
          ...
          <li>Leave the background transparent — the scenes draw nothing where nothing belongs.</li>

          <li>Everything you change in the control room appears on air immediately; there is
            nothing to refresh.</li>
        </ol>
      </div>
